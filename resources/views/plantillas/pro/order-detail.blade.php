...
@section('cotent')
    ...
    <section class="title-basic-section" xmlns="http://www.w3.org/1999/html">
        <article>
            <h3>
                Detalle de la orden
                <a href="{{ route('store.front.product.orden.show', [$tienda->store_route]) }}" class="btn btn-default core-rigth">Volver al carrito</a>
            </h3>
    ...
    <section class="container-products content-buttons-to-sale">
        <article>
            @if($pago == 1)
                {!! Form::submit('Pagar con Tarjeta de crédito', ['class' => 'btn btn-primary']) !!}
            @endif
