...
@section('cotent')
    ...
    <section class="title-basic-section">
        <article>
                ...
                <button type="submit" class="btn btn-sm core-rigth">Vaciar carrito</button>
                {!! Form::close() !!}

                <a href="{{ route('store.front', [$tienda->store_route]) }}" class="btn btn-sm btn-default core-rigth">Seguir comprando</a>
                    ...
                    @foreach($cart as $item)
                        <tr>
                            ...
                            <td>
                                ...
                                {!! Form::hidden('id', $item->producto_id, ['id' => 'id']) !!}
                                {!! Form::number('cantidad', $item->quantity, ['class' => 'form-control btn btn-sm input-count-unit'] ) !!}
