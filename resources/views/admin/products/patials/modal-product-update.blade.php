        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                    ...
                    <div class="row col-md-6">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                ...
                                {!! Form::text('nombre', '', array('id'=>'nombre-up','class'=> 'form-control form-with-100 form-group-validate-up val_text_num', 'placeholder' => 'Nombre')) !!}
                            </div>
                        </div>
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-12">
                            <div class="form-group">
                                ...
                                {!! Form::text('codigo_producto','', array('id'=>'codigo_producto-up','class'=> 'form-control form-with-100 form-group-validate-up val_text_num', 'placeholder' => 'Codigo del producto')) !!}
                            </div>
                        </div>
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-12">
                            <div class="form-group">
                                ...
                                {!!  Form::number('cantidad_disponible', '0', ['id'=>'cantidad_disponible-up','class'=> 'form-control form-with-100 form-group-validate-up val_num'])  !!}
                            </div>
                        </div>
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-12">
                            <div class="form-group">
                                ...
                                {!! Form::text('precio', '', array('id'=>'precio-up','class'=> 'form-control form-with-100 form-group-validate-up val_double', 'placeholder' => 'Precio')) !!}
                            </div>
                        </div>
                ...
                <div class="modal-footer">
                    ...
                    <button id="btn-update-product" type="button" class="btn btn-primary btn-sm btn-sm-radius btn-shadow-blue" data-toggle="modal" data-target="#modalUpdateProduct">Actualizar</button>
                </div>
            </div>
        </div>
    </div>
