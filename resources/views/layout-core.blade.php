...
<section id="main">
    ...
    <div id="main-header">
        <div id="main-header-app">
            <div>@yield('title-header', 'App')<span class="fa fa-angle-down fa-lg"></span></div>
        </div>
        ...
        <div id="options-core">
            <nav class="navbar navbar-default">
                <div class="navbar-header">
                    ...
                    <a href="#" class="btn btn-sm tool-margin-left-button core-logo-global"><span>@lang('core.codizer')</span> @lang('core.version')</a>
                </div>
