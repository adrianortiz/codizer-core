...
namespace {
    ...
    class Core extends \App\Facades\Core{
         ...
         * @static 
         */
        public static function isRouteValid($nameFirstName){
            return \App\Components\Core::isRouteValid($nameFirstName);
        }
         ...
         * @static 
         */
        public static function getPerfil($nameFirstName){
            return \App\Components\Core::getPerfil($nameFirstName);
        }
         ...
         * @static 
         */
        public static function getContact($perfil){
            return \App\Components\Core::getContact($perfil);
        }
        ...
        public static function getUserPerfil(){
            return \App\Components\Core::getUserPerfil();
        }
        ...
        public static function getUserContact(){
            return \App\Components\Core::getUserContact();
        }
